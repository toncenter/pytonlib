...
address = "EQCx9xXwEZ2qFCUTxyuvLeXeEV6vZT5DVaBXgflwa4kte1s9"
address_in_bytes = base64.urlsafe_b64decode(address)[1:-2]
print(address_in_bytes)

new_flag = 0x51.to_bytes(1)

new_address = new_flag + address_in_bytes

print(new_address)

crc = crc16(new_address)

assert crc16(new_address) == calcCRC(new_address)

print(crc16(new_address) == calcCRC(new_address))

print(crc)

new_address += crc

print(base64.urlsafe_b64encode(new_address))
